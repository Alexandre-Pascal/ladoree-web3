...
describe("LDRToken", function () {
    ...
    beforeEach(async function () {
        ...
        tokenDistribution = (await TokenDistributionMock.deploy()) as TokenDistribution;
    ...
    describe("Use Token", function () {
        ...
        it("Should allow users buy discount for buyers", async function () {
            ...
            expect(await ldrToken.balanceOf(user1.getAddress())).to.equal(amountToMint - 50);
        });
    ...
    describe("Edge Cases", function () {
        ...
        it("Should emit TokensMinted event on successful mint", async function () {
            ...
            await expect(ldrToken.connect(owner).mint(user1.getAddress(), amountToMint))
        ...
        it("Should emit MintAdjusted if minting would exceed the cap", async function () {
            ...
            await expect(ldrToken.connect(owner).mint(user1.getAddress(), amountToMint2))
